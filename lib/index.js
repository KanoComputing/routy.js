...
//
// Extend function and options from given route instance
//
...
Router.prototype.bindLinks = function () {
    ...
    this._clickListener = function (evt) {
        var href = getHrefRec(evt.target),
            blankTarget = evt.target.getAttribute('target') === '_blank',
            specialKey = evt.metaKey || evt.ctrlKey || evt.shiftKey || evt.altKey;
